...
- Do NOT suggest try/catch every where unless you are sure it's a real issue.
- Do NOT suggest changes to string literals unless you are sure it's a real issue.
